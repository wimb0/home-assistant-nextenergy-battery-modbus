...
WORK_MODE_MESSAGES = {
    ...
    4: "Peak Shaving", 5: "Power Station", 6: "Force Charge", 7: "Force Discharge",
}
...
STATIC_SENSORS = {
    "model_name": ("Model Name", 30000, 1, None, None, None, True, 8, "mdi:home-battery-outline"),
    ...
    "battery_flag": ("Battery Flag", 37636, 1, None, None, None, False, 1, "mdi:flag-outline"),
    "bms_master_type": ("BMS Master Type", 37004, 1, None, None, None, False, 1, "mdi:information-outline"),
    ...
    "max_apparent_power": ("Max Apparent Power (Smax)", 39057, 0.001, UnitOfApparentPower.KILO_VOLT_AMPERE, SensorDeviceClass.APPARENT_POWER, None, False, 2, None),
    "max_reactive_power_fed": ("Max Reactive Power Fed", 39059, 0.001, UnitOfReactivePower.KILO_VOLT_AMPERE_REACTIVE, SensorDeviceClass.REACTIVE_POWER, None, False, 2, None),
    "max_reactive_power_absorbed": ("Max Reactive Power Absorbed", 39061, 0.001, UnitOfReactivePower.KILO_VOLT_AMPERE_REACTIVE, SensorDeviceClass.REACTIVE_POWER, None, False, 2, None),
}

DYNAMIC_SENSORS = {
    "bms_connection_status": ("BMS Connection Status", 37002, 1, None, None, None, False, 1, "mdi:lan-connect"),
    "bms_voltage": ("BMS Voltage", 37609, 0.1, UnitOfElectricPotential.VOLT, SensorDeviceClass.VOLTAGE, SensorStateClass.MEASUREMENT, False, 1, "mdi:sine-wave"),
    "bms_current": ("BMS Current", 37610, 0.1, UnitOfElectricCurrent.AMPERE, SensorDeviceClass.CURRENT, SensorStateClass.MEASUREMENT, False, 1, "mdi:current-dc"),
    ...
    "bms_fault_1": ("BMS Fault 1", 37626, 1, None, None, None, False, 1, "mdi:alert-outline"),
    "bms_fault_2": ("BMS Fault 2", 37627, 1, None, None, None, False, 1, "mdi:alert-outline"),
    "bms_fault_3": ("BMS Fault 3", 37628, 1, None, None, None, False, 1, "mdi:alert-outline"),
    "bms_fault_4": ("BMS Fault 4", 37629, 1, None, None, None, False, 1, "mdi:alert-outline"),
    "bms_fault_5": ("BMS Fault 5", 37630, 1, None, None, None, False, 1, "mdi:alert-outline"),
    "bms_fault_6": ("BMS Fault 6", 37631, 1, None, None, None, False, 1, "mdi:alert-outline"),
    ...
    "r_phase_voltage": ("R Phase Voltage", 38802, 0.1, UnitOfElectricPotential.VOLT, SensorDeviceClass.VOLTAGE, SensorStateClass.MEASUREMENT, False, 2, "mdi:sine-wave"),
    "s_phase_voltage": ("S Phase Voltage", 38804, 0.1, UnitOfElectricPotential.VOLT, SensorDeviceClass.VOLTAGE, SensorStateClass.MEASUREMENT, False, 2, "mdi:sine-wave"),
    "t_phase_voltage": ("T Phase Voltage", 38806, 0.1, UnitOfElectricPotential.VOLT, SensorDeviceClass.VOLTAGE, SensorStateClass.MEASUREMENT, False, 2, "mdi:sine-wave"),
    "r_phase_current": ("R Phase Current", 38808, 0.001, UnitOfElectricCurrent.AMPERE, SensorDeviceClass.CURRENT, SensorStateClass.MEASUREMENT, False, 2, "mdi:current-ac"),
    "s_phase_current": ("S Phase Current", 38810, 0.001, UnitOfElectricCurrent.AMPERE, SensorDeviceClass.CURRENT, SensorStateClass.MEASUREMENT, False, 2, "mdi:current-ac"),
    "t_phase_current": ("T Phase Current", 38812, 0.001, UnitOfElectricCurrent.AMPERE, SensorDeviceClass.CURRENT, SensorStateClass.MEASUREMENT, False, 2, "mdi:current-ac"),
    ...
    "grid_r_voltage": ("Grid R Voltage", 39123, 0.1, UnitOfElectricPotential.VOLT, SensorDeviceClass.VOLTAGE, SensorStateClass.MEASUREMENT, False, 1, "mdi:sine-wave"),
    "grid_s_voltage": ("Grid S Voltage", 39124, 0.1, UnitOfElectricPotential.VOLT, SensorDeviceClass.VOLTAGE, SensorStateClass.MEASUREMENT, False, 1, "mdi:sine-wave"),
    "grid_t_voltage": ("Grid T Voltage", 39125, 0.1, UnitOfElectricPotential.VOLT, SensorDeviceClass.VOLTAGE, SensorStateClass.MEASUREMENT, False, 1, "mdi:sine-wave"),
    ...
    "grid_frequency": ("Grid Frequency", 39139, 0.01, UnitOfFrequency.HERTZ, SensorDeviceClass.FREQUENCY, SensorStateClass.MEASUREMENT, False, 1, "mdi:sine-wave"),
    ...
    "output_energy_total": ("Output Energy Total", 39621, 0.01, UnitOfEnergy.KILO_WATT_HOUR, SensorDeviceClass.ENERGY, SensorStateClass.TOTAL_INCREASING, False, 2, None),
    "output_energy_today": ("Output Energy Today", 39623, 0.01, UnitOfEnergy.KILO_WATT_HOUR, SensorDeviceClass.ENERGY, SensorStateClass.TOTAL_INCREASING, False, 2, None),
    "input_energy_total": ("Input Energy Total", 39625, 0.01, UnitOfEnergy.KILO_WATT_HOUR, SensorDeviceClass.ENERGY, SensorStateClass.TOTAL_INCREASING, False, 2, None),
    "input_energy_today": ("Input Energy Today", 39627, 0.01, UnitOfEnergy.KILO_WATT_HOUR, SensorDeviceClass.ENERGY, SensorStateClass.TOTAL_INCREASING, False, 2, None),
...
DISABLED_BY_DEFAULT = [
    ...
    "bms_master_type", "battery_flag",
    "max_apparent_power", "max_reactive_power_fed", "max_reactive_power_absorbed",
    "bms_fault_1", "bms_fault_2", "bms_fault_3",
    "bms_fault_4", "bms_fault_5", "bms_fault_6",
]
